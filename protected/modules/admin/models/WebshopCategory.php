<?php
	...
	class WebshopCategory extends CActiveRecord {
		...
		function rules() {
			return array( array( 'name, url, image_id', 'required' ), array( 'name, url, image_id', 'length', 'max' => 32 ), array( 'url', 'match', 'pattern' => '/^[A-Za-z0-9][\w]+$/', 'message' => '{attribute} может содержать только латинские буквы' ) );
		}

		function attributeLabels() {
			return array( 'id' => 'ID', 'name' => 'Название', 'url' => 'Адрес ссылки', 'image_id' => 'Картинка' );
		}
