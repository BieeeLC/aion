<?php
	($model->isNewRecord ? $this->setPageTitle( 'Добавление новости' ) : $this->setPageTitle( 'Редактирование новости' ));
	echo '
...
';
	...
	tinymce.init({
		...
		height : 300,
		language_url : \'';
	echo Power::url( 'js/tinymce/langs/ru.js' );
	echo '\',
		plugins: [
...
<di';
	...
	echo '</td>
					<td>';
	echo $form->dropDownList( $model, 'comments_enable', array( 1 => 'Включено', 0 => 'Отключено' ) );
	echo '</td>
				</tr>
				<tr>
					<td>';
	...
	echo '</td>
				...
				<tr>
					<td></td>
					<td>';
	echo CHtml::submitbutton( ($model->isNewRecord ? 'Добавить новость' : 'Сохранить изменения'), array( 'class' => 'button' ) );
	echo '</td>
				</tr>
			</table>
			';
