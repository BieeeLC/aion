			...
			<div class="membership">
				...
				<div class="membership-info">
					<div class="table border">
						...
						<div class="row ">
							<div class="w75">Цена</div>
							<div><b><?php echo $data['price']; ?></b> <img class="fix" src="<?php echo Power::url('images/point_gold.png'); ?>" /></div>
						</div>
					</div>
				</div>
				<div class="membership-button">
					<?php echo CHtml::dropDownList("membership_accounts", false, Power::getUserAccounts(), array('empty' => '-- Аккаунт --')); ?>
					<button id="<?php echo $data['id']; ?>" class="button" disabled="true">Купить</button>
