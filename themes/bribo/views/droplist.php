<?php $this->setPageTitle('Дроплист сервера'); ?>

<div class="note">
	<div class="note-title">Поиск по дроплисту сервера</div>
	<div class="note-body">
		...
		<div class="table">
			...
			<div class="row">
				<div></div>
				<div class="w200"><?php echo CHtml::submitButton('Найти', array('class'=>'button')); ?></div>
				<div></div>
			</div>
		</div>
		<?php $this->endWidget(); ?>
...
<?php if ($model): ?>
<div class="note">
	<div class="note-title">Список вещей</div>
	<div class="note-body">
		<table class="table">
			<tr>
				<th>Название</th>
