<?php $this->setPageTitle('Добавление существующего аккаунта'); ?>

<div class="note">
	<div class="note-title">Добавление существующего аккаунта</div>
	<div class="note-body">
		...
		<div class="table">
			...
			<div class="row">
				<div></div>
				<?php echo CHtml::submitButton('Добавить аккаунт', array('class'=>'button')); ?>
			</div>
		</div>
		<?php $this->endWidget(); ?>
	</div>
