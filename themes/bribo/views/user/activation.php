<?php $this->setPageTitle('Повторная отправка письма для активации аккаунта'); ?>

<div class="note">
	<div class="note-title">Повторная отправка письма для активации аккаунта</div>
	<div class="note-body">
		...
		<div class="table">
			...
			<div class="row">
				<div></div>
				<div class="w200"><?php echo CHtml::submitButton('Отправить', array('class'=>'button')); ?></div>
			</div>
		</div>
		<?php $this->endWidget(); ?>
	</div>
