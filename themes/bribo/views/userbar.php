<?php $this->setPageTitle('Создание юзербара'); ?>
...
<div class="note">
	<div class="note-title">Создание юзербара</div>
	<div class="note-body">
		...
		<div class="table">
			...
			<div class="row">
				<div class="bold">Выберите цвет</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="full center"><?php echo CHtml::submitButton('Создать юзербар', array('id'=>'submitUserbar','class'=>'button', 'disabled'=>true)); ?></div>
			</div>
		</div>
		<?php $this->endWidget(); ?>
	</div>
...
<?php if ($image): ?>
<div class="note">
	<div class="note-title">Ссылки на юзербар</div>
	<div class="note-body">
		<div class="table">
			<div class="row">
				<div>Результат</div>
